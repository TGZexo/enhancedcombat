...
public class TestBlock extends EnhancedcombatModElements.ModElement {
	@ObjectHolder("enhancedcombat:test")
	public static final Block block = null;
	public TestBlock(EnhancedcombatModElements instance) {
		super(instance, 1);
	}
